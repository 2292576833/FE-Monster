...
当前 Windows 版本为 **2.1.1 联网安装修复正式版**。全新安装、当前版原位升级、≤1.1.6 旧版升级、用户记录逐文件保留和安装后公网社区连通门禁均已通过。
...
- **代码签名仍未完成**：2.1.1 联网安装器会提供外部 SHA-256 sidecar，但仓库尚未配置 Authenticode，Windows SmartScreen 可能提示未知发布者。
...
- `UPDATE.md`：2.1.1 联网安装修复正式版范围、安装器和校验要求。
